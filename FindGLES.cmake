...
find_path(GLES_INCLUDE_DIR NAMES GLES/gl.h PATHS $ENV{KHRONOS_HEADERS}
...
find_library(GLES_LIBRARY NAMES GLESv1_CM libGLESv1_CM PATHS $ENV{OPENGLES_LIBDIR}
...
if(EMSCRIPTEN)
    set(GLES_FOUND TRUE)
    SET(GLES_INCLUDE_DIR "${EMSCRIPTEN_ROOT_PATH}/system/include")
    set(GLES_LIBRARY "nul")
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(GLES DEFAULT_MSG GLES_INCLUDE_DIR)

    ...
    if(CC_NAME STREQUAL "msvc")
        ...
        while(TESTPOS GREATER 0)
            ...
            if(LASTTEST STREQUAL "")
                exec_program(OpenCppCoverage ${CTEST_BINARY_DIRECTORY}/Debug ARGS --sources ${CTEST_SOURCE_DIRECTORY}/source --export_type=binary -- ${TEST}.exe)
            elseif(TESTPOS MATCHES -1)
                exec_program(OpenCppCoverage ${CTEST_BINARY_DIRECTORY}/Debug ARGS --sources ${CTEST_SOURCE_DIRECTORY}/source --export_type=cobertura --input_coverage=${LASTTEST}.cov -- ${TEST}.exe)
                file(RENAME ${CTEST_BINARY_DIRECTORY}/Debug/${TEST}Coverage.xml ${CTEST_BINARY_DIRECTORY}/coverage.xml)
            else()
                exec_program(OpenCppCoverage ${CTEST_BINARY_DIRECTORY}/Debug ARGS --sources ${CTEST_SOURCE_DIRECTORY}/source --export_type=binary --input_coverage=${LASTTEST}.cov -- ${TEST}.exe)
            endif()
            set(LASTTEST ${TEST})
        endwhile()
    endif()

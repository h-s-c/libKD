...
set(CTEST_CONFIGURE_COMMAND "cmake -DKD_BUILD_CI_FLAGS=\"-G${CC_FLAGS}\" -DCMAKE_BUILD_TYPE:STRING=${CTEST_CONFIGURATION_TYPE} \"-G${CTEST_CMAKE_GENERATOR}\" \"${CTEST_SOURCE_DIRECTORY}\"")

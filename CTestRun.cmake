...
set(ORIG_BUILD_NAME ${CTEST_BUILD_NAME})
...
if(CTEST_COVERAGE_COMMAND)
    ...
    set(CTEST_CONFIGURATION_TYPE "Debug")
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-cov")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
...
if(CTEST_MEMORYCHECK_COMMAND)
    ...
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-valgrind")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
    ...
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-helgrind")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=-fno-omit-frame-pointer")
    ctest_build()
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "AddressSanitizer")
    ...
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-asan")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "MemorySanitizer")
    ...
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-msan")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "ThreadSanitizer")
    set(CTEST_MEMORYCHECK_SANITIZER_OPTIONS "verbosity=1")
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-tsan")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "UndefinedBehaviorSanitizer")
    ...
    set(CTEST_BUILD_NAME "${ORIG_BUILD_NAME}-ubsan")
    ctest_start(Continuous)
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})

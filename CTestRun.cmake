...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "UndefinedBehaviorSanitizer")
    set(CTEST_MEMORYCHECK_SANITIZER_OPTIONS "help=1 verbosity=1 print_stacktrace=1")
...
if(CTEST_MEMORYCHECK_COMMAND)
    ...
    set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "--tool=memcheck --track-origins=yes --leak-check=yes --show-reachable=yes")
    ctest_configure()
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)

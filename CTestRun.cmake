...
if(UNIX)
    ...
    exec_program(cat ARGS /proc/sys/kernel/randomize_va_space OUTPUT_VARIABLE CI_ASLR)
else()
    set(CC_NAME "msvc")
...
if(CC_NAME STREQUAL "gcc")
    if(CC_VERSION VERSION_GREATER 4.9 OR CC_VERSION VERSION_EQUAL 4.9)
        ...
        set(CC_UBSAN_FLAGS "-fsanitize=address,undefined")
    endif()
elseif(CC_NAME STREQUAL "clang")
    if(CC_VERSION VERSION_GREATER 3.3 OR CC_VERSION VERSION_EQUAL 3.3)
        set(CTEST_MEMORYCHECK_TYPE "UndefinedBehaviorSanitizer")
        set(CC_UBSAN_FLAGS "-fsanitize=address,undefined,integer")
    endif()
endif()
if(CTEST_MEMORYCHECK_TYPE STREQUAL "UndefinedBehaviorSanitizer")
    ...
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=${CC_UBSAN_FLAGS} -fno-sanitize=vptr -fno-sanitize-recover -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()

...
elseif(DEFINED ENV{SEMAPHORE})
    ...
    set(CTEST_SOURCE_DIRECTORY "/home/scrutinizer/build")
...
if(CTEST_COVERAGE_COMMAND)
    ...
    if(CC_NAME STREQUAL "msvc")
        ...
        endwhile()
        exec_program(python ${CTEST_SOURCE_DIRECTORY} ARGS ci/merge_cobertura.py -p "${CTEST_BINARY_DIRECTORY}/Debug" -o "${CTEST_BINARY_DIRECTORY}/Debug/coverage.xml")

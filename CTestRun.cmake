if(UNIX)
    if(DEFINED ENV{CC})
        ...
        if(CC STREQUAL "clang")
            set(CC_NAME "clang")
            execute_process(COMMAND $ENV{CC} -v COMMAND grep version COMMAND sed "s/.*version\([0-9]*\\.[0-9]*\).*/\\1/" OUTPUT_VARIABLE CC_VERSION)
        endif()
    else()
        set(CC_NAME "gcc")
...
if(DEFINED ENV{APPVEYOR})
    ...
    set(CI_BUILD_NAME "${CI_COMMIT_ID}-${CC_NAME}-${CC_VERSION}-($ENV{APPVEYOR_BUILD_NUMBER})")

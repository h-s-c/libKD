...
if(CC_NAME STREQUAL "gcc")
    if(CC_VERSION VERSION_GREATER 4.8 OR CC_VERSION VERSION_EQUAL 4.8)
        # Need to check for libtsan package first
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "ThreadSanitizer")
    ...
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=${CC_TSAN_FLAGS} -fsanitize=thread -fPIC -pie -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "MemorySanitizer")
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=-fsanitize=memory -fsanitize-memory-track-origins=2 -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()

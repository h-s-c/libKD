...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "ThreadSanitizer")
    ...
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=-fsanitize=thread -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "UndefinedBehaviorSanitizer")
    ...
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=-fsanitize=undefined,integer -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "MemorySanitizer")
    ctest_configure(OPTIONS "-DKD_BUILD_CI_FLAGS=-fsanitize=memory -fsanitize-memory-track-origins -fPIE -pie -fno-omit-frame-pointer")
    ctest_build()
    ctest_memcheck()
    ctest_submit(PARTS MemCheck)
endif()

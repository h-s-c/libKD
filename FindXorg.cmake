...
pkg_check_modules(PC_XORG QUIET xcb xcb-ewmh xcb-icccm xcb-util xkbcommon)

find_path(XCB_INCLUDE_DIR NAMES xcb/xcb.h PATHS ${PC_XORG_INCLUDE_DIRS})
find_path(XCB_RANDR_INCLUDE_DIR NAMES xcb/randr.h PATHS ${PC_XORG_INCLUDE_DIRS})
...
set(XORG_INCLUDE_DIR ${XCB_INCLUDE_DIR} ${XCB_RANDR_INCLUDE_DIR} ${XCB_EWHM_INCLUDE_DIR} ${XCB_ICCCM_INCLUDE_DIR} ${XCB_UTIL_INCLUDE_DIR} ${XKBCOMMON_INCLUDE_DIR} ${XKBCOMMON_X11_INCLUDE_DIR})
list(REMOVE_DUPLICATES XORG_INCLUDE_DIR)

find_library(XCB_LIBRARY NAMES xcb PATHS ${PC_XORG_LIBRARY_DIRS})
find_library(XCB_RANDR_LIBRARY NAMES xcb-randr PATHS ${PC_XORG_LIBRARY_DIRS})
...
set(XORG_LIBRARIES ${XCB_LIBRARY} ${XCB_RANDR_LIBRARY} ${XCB_EWHM_LIBRARY} ${XCB_ICCCM_LIBRARY} ${XCB_UTIL_LIBRARY} ${XKBCOMMON_LIBRARY} ${XKBCOMMON_X11_LIBRARY})

find_package_handle_standard_args(XORG DEFAULT_MSG XORG_LIBRARIES)
mark_as_advanced(XCB_INCLUDE_DIR XCB_RANDR_INCLUDE_DIR XCB_EWHM_INCLUDE_DIR XCB_ICCCM_INCLUDE_DIR XCB_UTIL_INCLUDE_DIR XKBCOMMON_INCLUDE_DIR XKBCOMMON_X11_INCLUDE_DIR XCB_LIBRARY XCB_RANDR_LIBRARY XCB_EWHM_LIBRARY XCB_ICCCM_LIBRARY XCB_UTIL_LIBRARY XKBCOMMON_LIBRARY XKBCOMMON_X11_LIBRARY)